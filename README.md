...
`nf-villumina` will remove low quality reads and non-viral reads using Kraken2 and Centrifuge classification and perform Unicycler and Shovill assembly on the filtered reads. 
